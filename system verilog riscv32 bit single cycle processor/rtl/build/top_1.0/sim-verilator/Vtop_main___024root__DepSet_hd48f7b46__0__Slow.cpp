...
VL_ATTR_COLD void Vtop_main___024root___settle__TOP__3(Vtop_main___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtop_main__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtop_main___024root___settle__TOP__3\n"); );
    // Body
    ...
    vlSelf->top_main__DOT__a2_valid_o = (1U & (((IData)(vlSelf->reset)
                                                 ? 1U
                                                 : 0U) 
                                               & ((IData)(vlSelf->reset)
                                                   ? 1U
    ...
    if (vlSelf->top_main__DOT__d2_valid_o) {
        ...
        vlSelf->top_main__DOT__d_opcode_i_2 = vlSelf->top_main__DOT__d2_opcode_o;
    }
    if (vlSelf->reset) {
...
VL_ATTR_COLD void Vtop_main___024root___eval_settle(Vtop_main___024root* vlSelf) {
    ...
    // Body
    Vtop_main___024root___settle__TOP__3(vlSelf);
    vlSelf->__Vm_traceActivity[2U] = 1U;
    vlSelf->__Vm_traceActivity[1U] = 1U;
    vlSelf->__Vm_traceActivity[0U] = 1U;
}
...
VL_ATTR_COLD void Vtop_main___024root___ctor_var_reset(Vtop_main___024root* vlSelf) {
    ...
    vlSelf->top_main__DOT__d1_ready_i = VL_RAND_RESET_I(1);
    vlSelf->top_main__DOT__d2_ready_i = VL_RAND_RESET_I(1);
    vlSelf->top_main__DOT__d_opcode_i_1 = VL_RAND_RESET_I(3);
    vlSelf->top_main__DOT__d_opcode_i_2 = VL_RAND_RESET_I(3);
    vlSelf->top_main__DOT__a1_valid_o = VL_RAND_RESET_I(1);
    vlSelf->top_main__DOT__a1_opcode_o = VL_RAND_RESET_I(3);
    vlSelf->top_main__DOT__a1_address_o = VL_RAND_RESET_I(12);
    vlSelf->top_main__DOT__a1_data_o = VL_RAND_RESET_I(32);
    vlSelf->top_main__DOT__a1_size_o = VL_RAND_RESET_I(2);
    vlSelf->top_main__DOT__a1_mask_o = VL_RAND_RESET_I(2);
    vlSelf->top_main__DOT__a2_valid_o = VL_RAND_RESET_I(1);
    vlSelf->top_main__DOT__a2_opcode_o = VL_RAND_RESET_I(3);
    vlSelf->top_main__DOT__a2_address_o = VL_RAND_RESET_I(12);
    vlSelf->top_main__DOT__a2_data_o = VL_RAND_RESET_I(32);
    vlSelf->top_main__DOT__a2_size_o = VL_RAND_RESET_I(2);
    vlSelf->top_main__DOT__a2_mask_o = VL_RAND_RESET_I(2);
    ...
    vlSelf->top_main__DOT__d2_opcode_o = VL_RAND_RESET_I(3);
    vlSelf->top_main__DOT__core__DOT__channel_a_sel = VL_RAND_RESET_I(1);
    vlSelf->top_main__DOT__core__DOT__address = VL_RAND_RESET_I(10);
    ...
    vlSelf->top_main__DOT__core__DOT__pcsel = VL_RAND_RESET_I(2);
    ...
    vlSelf->top_main__DOT__inst_mem__DOT__instruction = VL_RAND_RESET_I(32);
    for (int __Vi0=0; __Vi0<4096; ++__Vi0) {
        vlSelf->top_main__DOT__inst_mem__DOT__mem[__Vi0] = VL_RAND_RESET_I(32);
    }
    vlSelf->top_main__DOT__d_mem__DOT__dataout = VL_RAND_RESET_I(32);
    vlSelf->top_main__DOT__d_mem__DOT__add = VL_RAND_RESET_I(12);
    for (int __Vi0=0; __Vi0<4096; ++__Vi0) {
        vlSelf->top_main__DOT__d_mem__DOT__mem[__Vi0] = 0;
    }
    vlSelf->top_main__DOT__d1__DOT__d_data_o__out__out0 = 0;
    vlSelf->top_main__DOT__d1__DOT__d_data_o__out__out1 = 0;
    vlSelf->top_main__DOT__d1__DOT__d_data_o__out__out2 = 0;
    vlSelf->top_main__DOT__d2__DOT__d_data_o__out__out0 = 0;
    vlSelf->top_main__DOT__d2__DOT__d_data_o__out__out1 = 0;
    vlSelf->top_main__DOT__d2__DOT__d_data_o__out__out2 = 0;
    vlSelf->__Vchglast__TOP__top_main__DOT__core__DOT__pcreg = VL_RAND_RESET_I(32);
